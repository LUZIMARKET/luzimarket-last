    ...
    <header className="sticky top-0 z-50 bg-white border-b" data-testid="header">
      ...
      <div className="animate-in fade-in duration-300">
        ...
        <nav className="hidden md:flex items-center justify-center gap-12 pb-6 px-8 relative z-40">
          <Link href="/best-sellers" className="text-[11px] font-sans tracking-widest text-gray-800 hover:text-black">
            {tNav('bestSellers')}
          </Link>
          <Link href="/handpicked" className="text-[11px] font-sans tracking-widest text-gray-800 hover:text-black">
            {tNav('handpicked')}
          </Link>

          <div className="group relative">
            <Link href="/brands" className="text-[11px] font-sans tracking-widest text-gray-800 hover:text-black flex items-center cursor-pointer py-2">
          ...
          <div className="group relative">
            <Link href="/categories" className="text-[11px] font-sans tracking-widest text-gray-800 group-hover:text-black flex items-center cursor-pointer py-2 border-b-2 border-transparent group-hover:border-black transition-colors">
          ...
          <div className="group relative">
            <Link href="/occasions" className="text-[11px] font-sans tracking-widest text-gray-800 hover:text-black flex items-center cursor-pointer py-2">
